...
(function () {
  ...
  if (mapEl && listEl && window.L) {
    ...
    /* ------------------------------------------------------------------
       ...
       ------------------------------------------------------------------ */
    var amenities = [
      { key:'site', category:'Sunstone Towns', coords:[43.840951,-79.491938], modifier:'site', svg:homeSvg, zoom:16, title:'Sunstone Towns', addr:'Rutherford Rd &amp; Peter Rupert Ave, Vaughan' },
